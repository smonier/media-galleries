    ...
    $(document).ready(function () {
        ...
        $.get(
            ...
            function (data) {
                ...
                const thumbnailUrl = data.thumbnail_url + "&" + "image_resize=" + wistiaWidth;
                $("#wistia-thumbnail-${videoID}").attr("src", thumbnailUrl);
